...
from src.utils.constants import coords
from src.models.model import TransporterNets, eval_step
import jax
import jax.numpy as jnp
from IPython.display import display
from src.models.llm import encode_text
...
def run_cliport(optim, env, obs, text, video_path=None, show_state=False):
